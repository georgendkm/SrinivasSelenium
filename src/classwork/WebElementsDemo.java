...
public class WebElementsDemo extends LaunchBase{

	public static void main(String[] args) throws Exception{
		WebElementsDemo obj = new WebElementsDemo();
		obj.launchBrowser("Chrome", "http://automationpractice.com/index.php");
		obj.launchSign("test123@tttoo.com");
	}
	
	public void launchSign(String email) throws Exception {
